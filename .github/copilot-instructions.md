...
- **Main code:** `custom_components/decent_app/`
...
- `entity/` — Base entity class (`DecentAppEntity`)
...
- Entity MRO: `(PlatformEntity, DecentAppEntity)` — order matters
...
- Debug level: `custom_components.decent_app: debug` in `config/configuration.yaml`
