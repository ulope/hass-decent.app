...
This document describes all configuration options and settings available in the Decent.app custom integration.
...
```yaml
service: decent_app.example_service
target:
