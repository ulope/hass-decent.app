# Getting Started with Decent.app

This guide will help you install and set up the Decent.app custom integration for Home Assistant.
...
5. Add this repository URL: `https://github.com/ulope/hass-decent.app`
6. Set category to "Integration"
7. Click "Add"
8. Find "Decent.app" in the integration list
9. Click "Download"
10. Restart Home Assistant

### Manual Installation

1. Download the latest release from the [releases page](https://github.com/ulope/hass-decent.app/releases)
2. Extract the `decent_app` folder from the archive
3. Copy it to `custom_components/decent_app/` in your Home Assistant configuration directory
...
4. Select entities from "Decent.app"
...
- Report issues at [GitHub Issues](https://github.com/ulope/hass-decent.app/issues)

## Support

For help and discussion:

- [GitHub Discussions](https://github.com/ulope/hass-decent.app/discussions)
